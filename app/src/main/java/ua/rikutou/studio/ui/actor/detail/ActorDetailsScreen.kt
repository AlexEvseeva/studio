    ...
    BottomSheetScaffold(
        ...
        content = {
            Column(
                ...
                ElementContent(label = stringResource(R.string.nameLabel), name = state.actor?.entity?.name ?: "")
                ElementContent(label = stringResource(R.string.nicknameLabel), name = state.actor?.entity?.nickName ?: "")
                ElementContent(label = stringResource(R.string.roleLael), name = state.actor?.entity?.role ?: "")
